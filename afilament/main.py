...
def main():
    ...
    from_top_nucleus_unet_model = r"D:\BioLab\models\one_nucleus_top_view\CP_epoch100_nucleus_weight.corection_2_labling_512_512_no_agum.pth"
    unet_model_scale = 1
    ...
    is_plot_fibers = True
    is_plot_nodes = True
    is_auto_normalized = True
    norm_trh = (200, 200) #when auto chose it will be recalculated
