...
def train_net(net,
    ...
    val_loader = DataLoader(val, batch_size=3, shuffle=False, num_workers=8, pin_memory=True, drop_last=True)
    ...
    if net.n_classes > 1:
        ...
        pos_weight = torch.tensor(200).to(device=device)  #pos_weight is weight corf white of pixels compare to black
...
def get_args():
    ...
    parser.add_argument('-v', '--validation', dest='val', type=float, default=15,
