...
if __name__ == '__main__':
    actin_obj_cap= pickle.load(open(r"D:\BioLab\scr_2.0\afilament\analysis_data\actin_objects\img_num_0__cell_num_3_whole_3d_actin.obj", "rb"))

    df = pd.DataFrame(columns=['Layers'])
    for i, fiber in enumerate(actin_obj_cap.fibers_list):
